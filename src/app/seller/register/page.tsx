      ...
      <div className="page">
        ...
        <div className="deco-panel">
          ...
          <div className="deco-label">
            <p className="tagline">Sell smarter</p>
            <p className="sub">Dealo seller network</p>
          </div>
        </div>
        ...
        <div className="form-panel">
          <div className="card">
            ...
            <h1 className="heading">Seller Register</h1>
            <p className="sub-heading">Create your seller account to get started</p>
