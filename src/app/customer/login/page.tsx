...
export default function CustomerLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
  // ✅ Save to localStorage so homepage auth check passes
      ...
      <div className="page">
        ...
        <div className="deco-panel">
          ...
          <div className="deco-label">
            <p className="tagline">Dealo marketplace.</p>
            <p className="sub">AI-powered deals &amp; discovery</p>
          </div>
        </div>
        ...
        <div className="form-panel">
          <div className="card">
            ...
            <p className="sub-heading">Sign in to your account to continue</p>

            {/* ✅ Success message rendered via state */}
            {success && (
...
const StyledWrapper = styled.div`
  ...
  .panel-video-wrap {
    position: relative;
    width: 100%;
    /* takes up top ~65% of the panel height */
    height: 65%;
    flex-shrink: 0;
    z-index: 1;
  }
  ...
  /* fades the bottom of the video into the deco panel */
  .panel-video-fade {
    position: absolute;
    inset: 0;
  ...
  .deco-label {
    ...
    z-index: 3;
    padding: 24px 44px 0;
    /* slight pull-up to sit inside the fade overlap */
    margin-top: -48px;
  }
  ...
  .heading {
    ...
    letter-spacing: -0.03em;
    color: var(--text);
    /* increased gap between cube and title */
    margin-top: 32px;
    margin-bottom: 10px;
  }
